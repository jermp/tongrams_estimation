...
int main(int argc, char** argv) {
    ...
    parser.add("ram",
               ...
               "--ram", false);
    parser.add("tmp_dir",
               "Temporary directory used for counting. Default is directory '" +
    ...
    if (config.max_order == 0 or config.max_order > global::max_order) {
    ...
    std::cerr << "counting with " << config.RAM << "/" << available_ram
              << " bytes of RAM"
